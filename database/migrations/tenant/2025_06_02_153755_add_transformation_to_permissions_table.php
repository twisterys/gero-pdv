...
return new class extends Migration
{
    ...
    public function up(): void
    {
        $permissions = [
            ...
            [
                'name' => 'transformation.liste',
                'guard_name' => 'web',
            ],
            [
                'name' => 'transformation.sauvegarder',
                'guard_name' => 'web',
            ],
            [
                'name' => 'transformation.afficher',
                'guard_name' => 'web',
            ],
            [
                'name' => 'transformation.annuler',
                'guard_name' => 'web',
            ],
            [
                'name' => 'transformation.supprimer',
                'guard_name' => 'web',
            ],
        ];
    ...
    public function down(): void
    {
        ...
        $permissionIds = DB::table('permissions')
            ->whereIn('name', [
                'transformation.*',
                'transformation.sauvegarder',
                'transformation.afficher',
                'transformation.supprimer',
            ])
            ->pluck('id')
            ->toArray();
