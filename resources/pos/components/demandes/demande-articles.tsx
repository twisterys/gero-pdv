    ...
    return (
        <>
            <div className="px-4 py-3 border-b border-gray-100">
                <h5 className="text-gray-900 font-medium">Articles</h5>
            </div>
                        ...
                        <div className="flex" key={product.id}>
                            ...
                            >
                                ...
                                <div className="p-3 flex flex-col flex-grow">
                                    <h5 className="font-medium text-gray-900">{product.designation}</h5>
                                    <p className="text-gray-400 text-xs">{product.reference} - {product.quantity}{product.unit}</p>
                                    <h6 className="text-gray-900 mt-auto font-bold">{formatNumber(product.prix, true)}</h6>
                                </div>
                            </div>
                        </div>
                    ))}
