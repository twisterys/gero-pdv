...
@section('document-title', 'Abonnements Archivés')
                ...
                <div class="card-body">
                    ...
                    <div class="card-title">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{route('abonnements.liste')}}"><i class="fa fa-arrow-left"></i></a>
                                <i class="mdi mdi-archive me-2 text-warning"></i> Abonnements Archivés
                            </h5>
                    ...
                    <div class="switch-filter row px-3 d-none mt-2 mb-4">
                        ...
                        <div class="col-sm-3 col-12 mb-3">
                            ...
                            <select class="select2 form-control mb-3 custom-select" name="client_id" id="client-select"></select>
                        </div>
                    ...
                    <div class="row px-3">
                        <div class="col-12">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="datatable-archives">
                                    <thead>
                                        <tr>
                                            <!-- <th style="width: 20px">
    ...
    <script>
        $(document).ready(function() {
            $('#datatable-archives').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route("abonnements.archives") }}',
                columns: [
                    // { data: 'id', name: 'id' },
        ...
        $(document).on('click', '.desarchiver-abonnement', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#datatable-archives').DataTable().ajax.reload();
                },
                error: function(xhr) {
                    if (xhr.status === 419) {
                        toastr.warning('Session expirée. Veuillez actualiser la page.');
                    } else {
        ...
        $('#search-btn').click(function () {
            ...
            const date_abonnement = $('#date_abonnement').val();
            const date_expiration = $('#date_expiration').val();
            ...
            $('#datatable-archives').DataTable().ajax.url('{{ route("abonnements.archives") }}?' + $.param(params)).load();
        });




        // Select2 client filter
        $('#client-select').select2({
            width: '100%',
            placeholder: { id: '', text: 'Tous' },
            allowClear: true,
            ajax: {
