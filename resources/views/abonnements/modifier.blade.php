...
@section('document-title', 'Modifier Abonnement')
@push('styles')
...
@section('page')
    <form action="{{ route('abonnements.mettre_a_jour', $abonnement->id) }}" method="POST" class="needs-validation" novalidate
          autocomplete="off">
        @csrf
        @method('PUT') <!-- Utilisez PUT pour l'édition -->
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row px-3 align-items-start ">
                            <div class="col-12 col-mb-6 col-lg-3 col-md-4 mb-3">
                                ...
                                <div class="input-group d-grid" style="grid-template-columns:9fr 1fr ">
                                    <select required
                                        ...
                                        <option value="{{ $abonnement->client_id }}" selected>{{ $abonnement->client->nom }}</option>
                                    </select>
                            ...
                            <div class="col-12 col-mb-6 col-lg-3 col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    <select required
                                        ...
                                        <option value="{{ $abonnement->article_id }}" selected>{{ $abonnement->article->designation }}</option>
                                    </select>
                            ...
                            <div class="col-12 col-lg-6 col-md-4 mb-3">
                                ...
                                <input type="text"
                                       ...
                                       name="titre" value="{{ old('titre', $abonnement->titre) }}">
                                @if ($errors->has('titre'))
                            ...
                            <div class="col-12 col-mb-6 col-lg-3 col-md-4 mb-3">
                                <label for="date_abonnement" class="form-label required">
                                    Date d'abonnement
                                </label>
                                <input type="text"
                                       class="form-control {{ $errors->has('date_abonnement') ? 'is-invalid' : '' }}"
                                       id="date_abonnement" name="date_abonnement" required readonly
                                       value="{{ old('date_abonnement', \Carbon\Carbon::parse($abonnement->date_abonnement)->format('d/m/Y')) }}">
                            ...
                            <div class="col-12 col-mb-6 col-lg-3 col-md-4 mb-3">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('date_expiration', \Carbon\Carbon::parse($abonnement->date_expiration)->format('d/m/Y')) }}">
                            ...
                            <div class="col-12 col-lg-6 col-md-4 mb-6">
                                ...
                                <textarea name="description"
                                          ...
                                          id="description">{{ old('description', $abonnement->description) }}</textarea>
