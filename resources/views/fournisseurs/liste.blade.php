...
@section('document-title', 'Fournisseur')
@push('styles')
                ...
                <div class="card-body">
                    ...
                    <div class="card-title">
                        <div class="d-flex  justify-content-between align-items-center" >
                            <h5 class="m-0"><i class="mdi mdi-contacts  me-2 text-success"></i>Fournisseurs
                            </h5>
                            <div class="page-title-right">
                                <a href="{{ route('fournisseurs.ajouter') }}">
                    ...
                    <div class="row">
                        <div class="card-title switch-filter d-none col-12">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="m-0">Listes des fournisseurs</h5>
                            </div>
                            <hr class="border">
                        </div>
                        <div class="col-12">
...
@push('scripts')
    ...
    <script>
        ...
        const __dataTable_ajax_link = "{{ route('fournisseurs.liste') }}";
