...
@section('page')
    ...
    <div class="row __dashboard_container">
                ...
                <div class="card-body bg-soft-success  overflow-hidden position-relative  rounded">
                    <div class="d-flex flex-nowrap align-items-center">
                        ...
                        <div class="ms-4 f">
                            ...
                            <h6 class="m-0 text-muted  ">Factures à valider</h6>
                        </div>
                    </div>
        ...
        <div class="col-xl-3 col-12 col-md-6  __dashboard_sortable_item">
            <div class="card overflow-hidden">
                <div class="card-body bg-soft-info  overflow-hidden position-relative  rounded">
                    <div class="d-flex flex-nowrap align-items-center">
                        <i class="fa fa-money-bill text-info fa-3x"></i>
                        <div class="ms-4 ">
                            <h4 class="text-muted dashboard-text ">
                ...
                <div class="card-body bg-soft-success  overflow-hidden position-relative  rounded">
                    <div class="d-flex flex-nowrap align-items-center">
                        ...
                        <div class="position-absolute end-0 top-0 mt-3 me-3 ">
                            ...
                            <button class="border-0 h6 bg-white text-success p-1 rounded d-none ca ca-trigger">HT
                            </button>
                        </div>
                        <div class="ms-4 ca">
                            <h4 class="text-muted dashboard-text ">
                                {{number_format($ca_fa['ca'],2,'.',' ')}} MAD
                            </h4>
                            <h6 class="m-0 text-muted  ">Chiffre d'affaires TTC</h6>
                        </div>
                        <div class="ms-4 d-none ca">
                            <h4 class="text-muted dashboard-text ">
                                {{number_format($ca_fa['ca_ht'],2,'.',' ')}} MAD
                            </h4>
        ...
        <div class="col-xl-3 col-12 col-md-6  __dashboard_sortable_item">
            <div class="card overflow-hidden">
                <div class="card-body bg-soft-success  overflow-hidden  rounded">
                    <div class="d-flex flex-nowrap align-items-center">
                        <i class="fa fa-percentage text-success fa-3x"></i>
                        <div class="ms-4">
                            <h4 class="text-muted dashboard-text">
                                {{number_format($tva_recup,2,'.',' ')}} MAD
                            </h4>
                            <h6 class="m-0 text-muted  ">Solde TVA</h6>
                        </div>
                    </div>
        ...
        <div class="col-xl-3 col-12 col-md-6  __dashboard_sortable_item">
            <div class="card overflow-hidden">
                <div class="card-body bg-soft-info  overflow-hidden  rounded">
                    <div class="d-flex flex-nowrap align-items-center">
                        <i class="fa fa-money-check text-info fa-3x"></i>
                        <div class="ms-4">
                            <h4 class="text-muted dashboard-text">
                                {{ $cheque_a_encaisser }}
                            </h4>
                            <h6 class="m-0 text-muted  ">Chèques à encaisser</h6>
                        </div>
                    </div>
        ...
        <div class="col-xl-3 col-12 col-md-6  __dashboard_sortable_item">
            <div class="card overflow-hidden">
                <div class="card-body bg-soft-warning  overflow-hidden  rounded">
                    <div class="d-flex flex-nowrap align-items-center">
                        <i class="fa fa-money-check text-warning fa-3x"></i>
                        <div class="ms-4">
                            <h4 class="text-muted dashboard-text">
                                {{ $cheque_a_decaisser }}
                            </h4>
                            <h6 class="m-0 text-muted  ">Chèques à décaisser</h6>
                        </div>
                    </div>
            ...
            <div class="card overflow-hidden">
                <div class="card-body bg-soft-danger  overflow-hidden  rounded">
                    <div class="d-flex flex-nowrap align-items-center">
                        ...
                        <div class="ms-4">
                            <h4 class="text-muted dashboard-text">
                                {{number_format($total_depense,2,'.',' ')}} MAD
                            </h4>
        ...
        <div class="row __dashboard_container">
                        ...
                        <div class="card mb-0 overview shadow-none pt-3 overflow-y-scroll " style="max-height: 320px">
                            <table class="table table-bordered table-striped"
                                ...
                                @forelse($factures_echeance as $facture)
                                    <tr>
                                        <td>
                                            <a href="{{route('ventes.afficher',[$facture->type_document,$facture->id])}}"
                                               class="link-underline-info text-info">{{$facture->reference}}</a></td>
                                        <td><a class="link-underline-info text-info"
                                               href="{{route('clients.afficher',$facture->client_id)}}"
                                               target="_blank">{{$facture->client->nom}}</a></td>
                                        <td>{{$facture->jours_de_retard}}</td>
                                        <td class="dashboard-text">{{number_format($facture->total_ttc,2,'.',' ')}}MAD
                                        </td>
            ...
            <div class="col-md-4 col-12 __dashboard_item __dashboard_sortable_item">
                <div class="card" style="height: calc(100% - 24px)">
                    <div class="card-body">
                        <h5 class="text-black-50 pb-3"> Trésorerie {{today()->format('d/m/Y')}}</h5>
                            ...
                            <div class="col-12 my-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-8 text-end">
                                        ...
                                        <h4 class="mb-0 font-size-20 dashboard-text">{{number_format($compte->solde ,2,'.',' ')}}
                                            MAD</h4>
                                    </div>
                                </div>
                            </div>
