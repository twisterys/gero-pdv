                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 row mx-0 align-content-start">
                                ...
                                <div class=" col-sm-6 col-12 mb-3 ">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="ttc-input" value="{{round_number(old('i_montant')*(1+old('i_tax')/100))}}">
                                    </div>
                                </div>
...
@push('scripts')
    ...
    <script>
        ...
        $(document).on('input', '#tax-input, #montant-input', function () {
            let ttc = (Number($('#montant-input').val()) *(1+ Number($('#tax-input').val()/100))).toFixed({!! \App\Services\GlobalService::get_decimal_length() !!});
            $('#ttc-input').val(ttc)
        })
    </script>
@endpush
