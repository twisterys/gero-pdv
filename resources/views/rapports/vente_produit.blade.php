...
@section('document-title', 'Ventes de produits')
@push('styles')
    ...
    <div class="row">
        <div class="col">
            <div  class="card-title justify-content-between align-items-center">
                <h2 >Rapport des ventes de produit</h2>
            </div>
        </div>
                        ...
                        <div class=" col-xl-3 col-lg-4 col-md-5 col-sm-6 col-12 mt-2 mt-sm-0">
                            ...
                            <select name="i_type" class="form-control" id="i_type" multiple>
                                @foreach($types as $type)
                                    <option @if(in_array($type,$types_inclues)) selected @endif value="{{$type}}">@lang('ventes.'.$type)</option>
                                @endforeach
                            </select>
                        </div>
                        <div class=" col-xl-3 col-lg-4 col-md-5 col-sm-6 col-12 mt-2 mt-sm-0">
...
@push('scripts')
    ...
    <script>
        ...
        const __dataTable_ajax_link = "{{ route('rapports.vente-produit') }}";
