...
@section('document-title', 'Rapport des commerciaux')
@push('styles')
            ...
            <div class="card-body ">
                ...
                <div class="row align-items-end mb-4">
                    <div class=" col-xl-3 col-lg-4 col-md-5 col-sm-6 col-12 mt-2 mt-sm-0">
                        <label for="i_search" class="form-label">Recherche par commercial</label>
                        <div class="input-group">
                            <span class="input-group-text text-primary"><i class="fas fa-search"></i></span>
                            <input type="text" id="i_search" name="i_search" class="form-control" placeholder="Chercher par nom ou réference">
                        </div>
                    </div>
                    <div class=" col-xl-3 col-lg-4 col-md-5 col-sm-6 col-12 mt-2 mt-sm-0">
...
@push('scripts')
    ...
    <script>
        ...
        const __dataTable_ajax_link = "{{ route('rapports.commerciaux') }}";
