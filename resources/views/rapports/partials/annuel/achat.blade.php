<div class="ms-6 my-4 pe-5 d-flex justify-content-between bg-soft-primary rounded p-3">
 ...
 :</span>
    <span class="ms-3 text-dark">{{ number_format($achat_ca, 2, '.',' ') }}  DH</span>
</div>
...
<div class="ms-6 my-4 pe-5 d-flex justify-content-between bg-soft-info rounded p-3">
 ...
 :</span>
    <span class="ms-3 text-dark">{{ number_format($achat_ca_ht, 2, '.', ' ') }} DH</span>
</div>
<div class="ms-6 my-4 pe-5 d-flex justify-content-between bg-soft-success rounded p-3">
    ...
    <span class="ms-3 text-dark">{{ number_format($achat_recette, 2, '.', ' ') }} DH</span>
</div>
...
:</span>
    <span class="ms-3 text-dark">{{ number_format($achat_creance, 2, '.', ' ') }} DH</span>
</div>
...
:</span>
    <span class="ms-3 text-dark">{{ number_format($cumulated_achat_creance, 2, '.', ' ') }} DH</span>
</div>
