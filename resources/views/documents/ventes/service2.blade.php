...
<div class="content " style="padding-top: 2rem;width:100%;">
        ...
        <div class="to_address">
            ...
            <table style="width: 100%; padding-left:0px;">
                <tr>
                    ...
                    <td style="text-align: right;font-weight: bold;text-transform: capitalize; white-space: nowrap; vertical-align: top">{{$o_vente->client->nom}}</td>
                </tr>
                <tr>
                    <td style="white-space: nowrap; vertical-align: top">ICE:</td>
                    <td style="text-align: right; white-space: nowrap; vertical-align: top">{{$o_vente->client->ice}}</td>
                </tr>
                <tr>
                    <td style="white-space: nowrap; vertical-align: top">Adresse:</td>
                    <td style="text-align: right; white-space: nowrap; vertical-align: top"> {{$o_vente->client->adresse}}</td>
                </tr>
            </table>
        </div>
        <div class="side-left">
    ...
    <div class="col-md-12 "
        ...
        <table id="table-articles" style="height: {{$table_height}}px;max-height: {{$table_height}}px"
            ...
            @endif
                ...
                <th>Prix HT (MAD)</th>
                <th>TVA (%)</th>
                <th style="  border-bottom-right-radius: .25rem;border-top-right-radius: 0.25rem">
                    Total HT
                </th>
            </tr>
            </thead>
            ...
            @foreach($o_vente->lignes as $ligne)
                ...
                <tr class="items">
                    ...
                    <td>{{$ligne->taxe}} %</td>
                    <td style="white-space: nowrap">{{number_format(($ligne->ht-$reduction) *$ligne->quantite,3,'.',' ')}} MAD</td>
                </tr>
            @endforeach
            <tr>
                <td colspan="6" style="height: {{180 + ($o_vente->note ? 70 : 0)}}px;">
                </td>
            </tr>
            </tbody>
        </table>
    ...
    <div style="clear: both"></div>
    <div class="col-md-12 "
         style="page-break-inside: avoid; position: fixed; bottom: {{$o_template->image_en_bas_hauteur-70-($o_vente->note ? 0 : 40)}}px; height: {{160 + ($o_vente->note ? 70 : 0)}}px;width: 100%">
        ...
        @endif
        <div style="clear: both"></div>
        <table style="width: 100%; margin-top:1rem;padding-bottom:60px;">
            <tr>
                <td style="text-align: center">
                    <u>Signature de client</u>
                </td>
                <td style="text-align: center">
                    <u>Cachet & Signature</u>
                </td>
            </tr>
        </table>
        <div style="clear: both"></div>
