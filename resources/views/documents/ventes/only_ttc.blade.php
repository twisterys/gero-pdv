...
{{--                <th>TVA (%)</th>--}}
            ...
            @foreach($o_vente->lignes as $ligne)
                ...
                <tr class="items">
                    ...
                    {{-- AJOUT: Cellule pour la Référence --}}
                    <td style="white-space: nowrap; vertical-align: top; text-align: left;"> {{-- Appliquer styles ici ou via CSS --}}
                        {{ $ligne->article->reference ?? 'N/A' }}
                    </td>

                    <td style='vertical-align: top; word-wrap: break-word;'>
                        <b>{{$ligne->nom_article}}</b>
                        <div style='vertical-align: top; word-wrap: break-word; '>
...
{{--                    <td>{{$ligne->taxe}} %</td>--}}
            ...
            @endforeach
            <tr>
                <td colspan="5" style="height: {{160 + ($o_vente->note ? 70 : 0)}}px;">
                </td>
            </tr>
            </tbody>
        </table>
