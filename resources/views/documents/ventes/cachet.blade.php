        ...
        <div class="to_address">
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="text-align: right;font-weight: bold;text-transform: capitalize; vertical-align: top">{{$o_vente->client->nom}}</td>
                </tr>
                <tr>
...
<style>
    ...
    @page {
        margin: {{$o_template->image_en_tete_hauteur ? $o_template->image_en_tete_hauteur+20 : 0}}px 1.5cm {{$o_template->image_en_bas_hauteur+$o_template->cachet_hauteur??0}}px 1.5cm;
        size: A4;
    }
    ...
    #footer-bg {
        ...
        bottom: -{{$o_template->image_en_bas_hauteur+$o_template->cachet_hauteur??0}}px;
    ...
    #cachet-bg {
        position: relative;
        width: 170px;
        height: {{$o_template->cachet_hauteur??0}}px;
        left:420px;
        bottom: 35px;
        background-image: url('{{$images['cachet']}}');
