        ...
        <table id="table-articles" style="height: {{$table_height}}px;max-height: {{$table_height}}px"
            ...
            @foreach($o_vente->lignes as $index => $ligne)
                ...
                <tr  style="width:100%;">
                    ...
                    <td  style="vertical-align: top; word-wrap: break-word ; white-space: nowrap"><div class="border" >{{number_format($ligne->ht,3,'.',' ')}} MAD

                        </div>
                    </td>
                    @if( $o_vente['total_reduction'] != 0)
                        <td  style="vertical-align: top; word-wrap: break-word ; white-space: nowrap"><div class="border" >{{number_format($ligne->reduction,3,'.',' ')}} {{$ligne->mode_reduction === 'fixe' ? 'MAD':'%'}}
                    ...
                    <td  style="vertical-align: top; word-wrap: break-word ;white-space: nowrap "><div class="border" >{{number_format(($ligne->ht-$reduction) *$ligne->quantite,3,'.',' ')}}  MAD
