...
@section('document-title','Ajouter Relance Template')
        ...
        <div class="card">
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data"
                      action="{{ route('relance.sauvegarder') }}" class="needs-validation"
                    ...
                    <div class="card-title">
                        <div id="__fixed" class="d-flex switch-filter justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="m-0">Paramétres de relance</h5>
                            </div>
                    ...
                    <div class="row col-12 mx-0">
                        ...
                        <div class="col-md-6 col-sm-12 form-group mb-4">
                            ...
                            <input  value="{{ old('subject') }}" type="text" class="form-control @error('subject') is-invalid @enderror" name="subject">
                            @error('subject')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-3 col-sm-12 form-group mb-4">
                            ...
                            <select required name="type" class="form-select " id="type">
                                ...
                                <option value="fp">Facture proforma</option>
                            </select>
                            @error('type')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12 mb-4 mt-2">
                            <div class="form-check-inline d-flex align-items-center">
                                ...
                                <input name="active" value="1" type="checkbox" id="active" switch="bool" checked  >
                        ...
                        <div class="col-md-9 col-sm-12 form-group mb-4 mt-2">
                            ...
                            <textarea name="content" id="content" class="form-control @error('content') is-invalid @enderror" rows="20" >{{ old('content') }}</textarea>
                            @error('content')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
