...
@section('document-title', 'Cheques à décaisser')
@push('styles')
...
@section('page')
                ...
                <div class="card-body">
                    ...
                    <div class="card-title">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="m-0">
                                <i class="mdi mdi-contacts  me-2 text-success"></i>Chéques à décaisser
                            </h5>
                            <div class="page-title-right">
                                    <button data-bs-target="#saveChequeModal" data-bs-toggle="modal" class="btn btn-soft-success"><i class="mdi mdi-plus"></i> Ajouter</button>
                    ...
                    <div class="switch-filter row px-3 d-none mt-2 mb-4">
                        ...
                        <div class="col-sm-3 col-12 mb-3">
                            <label for="fournisseur_filters" class="form-label required">Fournisseur</label>
                            <select required
                                    class="select2 form-control mb-3 custom-select "
                                    id="fournisseur_filters">
                            </select>
                        </div>
                        <div class="col-sm-3 col-12 mb-3">
            ...
            <div class="modal-content">
                <form  id="saveChequeModalForm" method="post">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="saveChequeModalLable">Ajouter le chèque</h5>
    ...
    <div class="modal fade" id="updateChequeModal" tabindex="-1" aria-labelledby="updateChequeModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
...
@push('scripts')
    ...
    <script>
        ...
        const __dataTable_ajax_link = "{{ route('cheques.decaisser_liste') }}";
        const __dataTable_id = "#datatable";
        const __dataTable_filter_inputs_id = {
            fournisseur_id: '#fournisseur_filters',
    ...
    @vite(['resources/js/cheques_decaisser.js']);
@endpush
