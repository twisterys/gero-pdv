        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('importer-achat') }}" method="POST" enctype="multipart/form-data" class="mt-3" onsubmit="return validateForm()">
                        @csrf
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label for="fileType" class="form-label me-2"> Selectionner le type des achats à importer</label>
                    ...
                    <hr class="border">
                    <div class="mb-3">
                        <a href="{{ asset('modele_csv/import_achats_v2.xlsx') }}" class="btn btn-soft-primary">Télécharger le modèle achat</a>
                    </div>
                </div>
            </div>
