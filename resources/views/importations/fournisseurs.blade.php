        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('importer-fournisseur') }}" method="POST" enctype="multipart/form-data" class="mt-3" onsubmit="return validateForm()">
                        @csrf
                    ...
                    <hr class="border">
                    <div class="mb-3">
                        <a href="{{ asset('modele_csv/import_fournisseurs.xlsx') }}" class="btn btn-soft-primary">Télécharger le modèle fournisseur</a>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                <td>Référence</td>
                                <td>Numéro de référence unique pour le fournisseur</td>
                            ...
                            <tr>
                                <td>Email</td>
                                <td>Adresse e-mail du fournisseur</td>
                                <td>Optionnel</td>
                            ...
                            <tr>
                                <td>Note</td>
                                <td>Remarques ou commentaires sur le fournisseur</td>
                                <td>Optionnel</td>
