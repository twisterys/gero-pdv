                ...
                <div class="card-body">
                    ...
                    <div class="card-title">
                        <div class="d-flex switch-filter justify-content-between align-items-center">
                            <h5 class="m-0">
                                <a href="{{route('importer-liste')}}"><i class="fa fa-arrow-left me-2"></i></a>
                                </i>Logs de {{$importation->reference}}</h5>
...
@push('scripts')
    ...
    <script>
        ...
        const __dataTable_ajax_link = "{{ route('importations.afficher', $importation->id)}}";
