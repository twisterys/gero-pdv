                    ...
                    <ul class="list-unstyled task-list">
                        <li>
                            ...
                            <div class="d-flex justify-content-between">
                                <p class="m-b-5"><strong>{{ Carbon::parse($jalon->date)->format('d/m/Y') }}</strong></p>
{{--                                <p class="m-b-5"><span>({{ $jalon->nom }})</span></p>--}}
                                <h5 class="text-muted">{{ $jalon->nom }}</h5>
