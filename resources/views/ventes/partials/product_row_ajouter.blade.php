...
<tr>
    <input type="hidden" class="article_id" name="lignes[{{$position}}][i_article_id]"
           value="{{old('lignes.'.$position.'.i_article_id')}}">
    <input type="hidden" class="article_reference" name="lignes[{{$position}}][i_article_reference]"
           value="{{old('lignes.'.$position.'.i_article_reference')}}">
    <td>
        ...
        <div class="description">{{old('lignes.'.$position.'.i_description')}}</div>
    ...
    <td>
        ...
        @enderror
        <select
            class="form-select row_select2 unite {{$errors->has('lignes.'.$position.'.i_unite')? 'is-invalid' : ''}}"
    ...
    <td class=" @if(!$prix_revient) d-none @endif">
        <input style="width: 120px"
               ...
               type="number"
               name="lignes[{{$position}}][i_prix_revient]" value="{{old('lignes.'.$position.'.i_prix_revient')}}">
        @error('lignes.'.$position.'.i_prix_revient')
        <div class="invalid-feedback">
            {{ $errors->first('lignes.'.$position.'.i_prix_revient') }}
        </div>
        @enderror
    </td>
    <td>
