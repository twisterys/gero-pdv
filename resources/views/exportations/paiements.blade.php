        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('exporter-paiement') }}" method="POST" enctype="multipart/form-data" class="mt-3">
                        @csrf
                        <div class="row">
                        ...
                        <hr class="border">
                        <div class="mb-3">
                            <button type="submit" class="btn btn-soft-primary" id="export-btn">Exporter les paiements</button>
                        </div>
                    </form>
