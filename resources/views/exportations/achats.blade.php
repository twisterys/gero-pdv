        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('exporter-achat') }}" method="POST" enctype="multipart/form-data" class="mt-3">
                        @csrf
                        <div class="row">

                            <div class="col-md-4 mb-3">
                                <label class="form-label required" for="type">Type d'achat</label>
                                <select class="form-select" id="type" name="type" data-parsley-multiple="groups" data-parsley-mincheck="1">
                                    <option value="dva">Devis</option>
                                    <option value="bca">Commande</option>
                                    <option value="faa">Facture</option>
                                    <option value="bla">Reception</option>
                                    <option value="bra">Retour</option>
                        ...
                        <hr class="border">
                        <div class="mb-3">
                            <button type="submit" class="btn btn-soft-primary" id="export-btn">Exporter les achats</button>
                        </div>
                    </form>
