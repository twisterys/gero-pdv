<tr>
    <td>
        ...
        <textarea name="lignes[-1][i_description]" class="summernote"></textarea>
    </td>
    <td>
    ...
    <td>
        ...
        <select style="width: 120px" class="form-select row_select2 reduction_mode " name="lignes[-1][i_reduction_mode]" id="">
