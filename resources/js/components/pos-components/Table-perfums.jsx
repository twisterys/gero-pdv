...
// total reduction
    ...
    const handleTotalReduction = (e) => {
        const value = e.target.value;
        setTotalReduction(value);
        onTotalReductionChange(value);
    };
            ...
            <div
                ...
                <div className="row my-3">
                    <div className="col-12 d-flex justify-content-between align-items-center gap-5">
                        <h4 className="mr-3 text-nowrap">Total Reduction :</h4> {/* Increased margin-right here */}
                        <div className="input-group" style={{minWidth: '150px'}}>
                            <input
                                type="number"
                                value={totalReduction}
                                onChange={handleTotalReduction}
                                className="form-control"
                            />
                            <span className="input-group-text">%</span>
                        </div>
                ...
                <div className="row">
                    <div className="col-12 my-1 d-flex justify-content-between align-items-center">
                        ...
                        <h4 className="m-0">
                            {(paiement.i_montant - (paiement.i_montant * (isNaN(parseFloat(totalReduction)) ? 0 : parseFloat(totalReduction)) / 100))
