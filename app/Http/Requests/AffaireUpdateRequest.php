...
class AffaireUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'lignes.*.id' => '',
            'lignes.*.nom' => 'nullable|string|max:255',
            'lignes.*.jalon_date' => 'nullable|date_format:d/m/Y',
            'description' => 'nullable|string',
        ];
        $rules['reference'] = ['required', Rule::unique('affaires', 'reference')->ignore($this->id)];
