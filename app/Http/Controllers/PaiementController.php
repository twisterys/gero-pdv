    ...
    public function liste(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $table->addColumn('actions', function ($row) {
                ...
                $scale = \App\Services\GlobalService::get_decimal_length();
                return '<span class="text-success" >' . number_format($row->encaisser, $scale, '.', ' ') . ' MAD</span>';
            })->editColumn('decaisser', function ($row) {
                $scale = \App\Services\GlobalService::get_decimal_length();
                return '<span class="text-danger" >' . number_format($row->decaisser, $scale, '.', ' ') . ' MAD</span>';
